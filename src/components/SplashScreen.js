...
const SplashScreen = () => {
    ...
    return (
        <div className={splashStatus === false ? 'hidden' : ''}>
            <div id="hideSplashScreen" className="flex justify-center items-center fixed inset-0 w-full h-full bg-black z-50" style={{backgroundImage: "linear-gradient(to bottom right, #FF4359 10%, #AA1439, #68192F, #53192A, #000000 90%)"}}>
                <div className="text-center">
                    ...
                    <span className="inline-block mt-3 font-semibold text-2xl text-white" id="animateText">Gamers</span>
                </div>
            </div>
        </div>
    );
