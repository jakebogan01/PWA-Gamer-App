                ...
                <Slider {...settings}>
                    <div className="block pb-[6.4375rem] pt-[1.5625rem]">
                        <div className="relative flex flex-col h-full bg-cover bg-center bg-no-repeat rounded-[5.25rem]" style={{backgroundImage: "url('https://www.kemperlesnik.com/wp-content/uploads/2020/04/valorant-official-art.jpg')", boxShadow: "0 0.25rem 1.375rem rgb(255, 64, 64, 0.6)"}}>
                            <Link to="/1" className="absolute flex items-center justify-between -bottom-14 left-1/2 transform -translate-x-1/2 px-[2.375rem] py-[1.125rem] w-[17.3125rem] h-[5rem] bg-[#64182D] rounded-full z-20">
                                <span className="block">
                                    <h3 className="font-semibold text-[1.625rem] leading-none">Valorant</h3>
                                    <span className="font-semibold text-sm text-white opacity-50">Video Game</span>
                                </span>
